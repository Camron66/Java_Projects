...
public class Controller {
    public static void main(String[] args) throws InterruptedException {
        ...
        for(int i=1; i<=7; i++){
            ...
            // sleep for a random time up to 1 seconds
            ...
            if(i % 3 == 0){
                ...
                john.getCreditCards().get(1).makeCharge(cafeMocha);
            }
        }//end for
        ...
        for(int i=1; i<=5; i++){
            ...
            // YOUR CODE HERE
            if (i % 2 == 0){
                john.getCreditCards().get(0).makeCharge(airlinesTicket);
            }else{
                john.getCreditCards().get(1).makeCharge(airlinesTicket);
            }
        ...
        for(int i=1; i<=10; i++){
            ...
            ArrayList<Item> cokes = new ArrayList<>();
            ...
            if (i < 11) {
                if (randomSelectCard == 0) {
                    john.getCreditCards().get(0).makeCharge(coke);
                }
                if (randomSelectCard == 1) {
                    john.getCreditCards().get(1).makeCharge(coke);
                }
            }
        }//end for
    ...
    public static void yourInfoHeader(){
        ...
        System.out.println("====================================================");
        System.out.println("PROGRAMMER: " + "CAMRON CISNEROS");
        System.out.println("PANTHER ID: " + "6187231");
        System.out.println();
        System.out.println("CLASS: " + "COP2210");
        System.out.println("SECTION: " + "U02 1218");
        System.out.println("SEMESTER: " + "FALL 2021");
        System.out.println("CLASSTIME: T/TH 5:00-7:40");
        System.out.println();
